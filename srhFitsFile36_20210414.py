...
#            self.calculatePhaseRcp_nonlinear(baselinesNumber = baselinesNumber)
    ...
    def calculatePhaseLcp_nonlinear(self, baselinesNumber = 2):
        ...
        ls_res = least_squares(self.northGainsFunc_constrained, x_ini, args = (redundantVisN, antNumberN, baselinesNumber), max_nfev = 250)
        ...
        ls_res = least_squares(self.eastWestGainsFunc_constrained, x_ini, args = (redundantVisEW, antNumberEW, baselinesNumber), max_nfev = 500)
