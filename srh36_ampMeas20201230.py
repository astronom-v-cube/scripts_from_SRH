...
#dateTime = '20201230T034901'
#dateTime = '20201230T060852'
dateTime = '20201230T070023'
...
for i in range(meanLcp.shape[0]):
    meanLInterp[i] = NP.interp(timeInterp,time[i],meanLcp[i])
    meanRInterp[i] = NP.roll(NP.interp(timeInterp,time[i],meanRcp[i]),-1,axis=0)
