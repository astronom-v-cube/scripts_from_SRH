...
from PyQt5.QtWidgets import QFileDialog, QTabWidget, QVBoxLayout, QGridLayout, QMainWindow, QWidget
...
class SrhEdik(QMainWindow):#QtWidgets.QWidget):#MainWindow):
...
#        if value == False:
#            self.imMinLcp, self.imMaxLcp = self.lcpData.min(), self.lcpData.max()
#            self.imMinRcp, self.imMaxRcp = self.rcpData.min(), self.rcpData.max()
        if (self.imageUpdate):
            self.buildImage()
...
#        
        ...
        self.doubleBaselinesPhaseButton.setChecked(True)
        ...
        self.histogramButton = QtWidgets.QPushButton('Brightness histograms', self)
        self.histogramButton.setCheckable(True)
        self.histogramButton.setChecked(False)
        self.histogramButton.clicked.connect(self.onHistogram)
        ...
        self.tabs.addTab(self.tab3,"Flagging")
        self.tabs.addTab(self.tab4,"Centering")
        self.tabs.addTab(self.tab5,"Save...")
        ...
        self.tab1.layout.addWidget(self.doubleBaselinesPhaseButton, 0, 6)
        self.tab1.layout.addWidget(self.doubleBaselinesAmplitudeButton, 1, 6)
        ...
        self.tab1.layout.addWidget(self.histogramButton, 0, 11)
        ...
        self.tab5.layout.addWidget(self.saveButton, 0, 0)
        ...
        layout.addWidget(self.lcpTextBox,1,0)
        layout.addWidget(self.rcpTextBox,1,1)
        layout.addWidget(self.lcpCanvas,4,0)
        layout.addWidget(self.rcpCanvas,4,1)
        layout.addWidget(self.lcpMaxCanvas,14,0,5,1)
        layout.addWidget(self.rcpMaxCanvas,14,1,5,1)
