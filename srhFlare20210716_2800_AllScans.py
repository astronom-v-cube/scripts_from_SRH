...
for fitsName in iFitses:
    ...
    mm = int(tHMS[1])
    ss = int(tHMS[2])
    time_0716_2800.append(hh*3600 + mm*60 + ss + int(tObs[1])*1e-6)
    fitsHandle.close()
...
for i in range(frames):
    Tbmax_0716_2800.append(iImages2800[i,325,420])
    flux_0716_2800.append(2*iImages2800[i,303:350,402:438].sum()*scipy.constants.k/(scipy.constants.c/3.4e9)**2 * NP.deg2rad(4.911/3600)**2 / 1e-22)
