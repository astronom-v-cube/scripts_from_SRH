...
class SrhFitsFile():
    ...
    def saveCalibrationResult(self):
        ...
        with open('srh612CurrentGains.json', 'w') as saveGainFile:
            json.dump(currentGainsDict, saveGainFile)
            
    def readCalibrationResult(self):
        try:
            with open('srh612CurrentGains.json','r') as readGainFile:
            ...
            print('File \"srh612CurrentGains.json\" not found')
...
#        return NP.abs(NP.reshape(qSun_lm_conv, uvSize**2))
    ...
    def centerDisk(self):
        ...
        self.temperatureCoefsLcp[self.frequencyChannel] = currentDiskTb/self.diskLevelLcp[self.frequencyChannel]
        self.temperatureCoefsRcp[self.frequencyChannel] = currentDiskTb/self.diskLevelRcp[self.frequencyChannel]
      
    def modelDiskConv(self):
        # self.createUvPsf(self.diskLevelLcp,0,0,0)
        self.createUvPsf(0.001,0,0,0)
