...
dateTime = '20201130T023009'
#dateTime = '20201130T040250'
#dateTime = '20201130T015418'
...
meanI = (meanLcp + meanRcp)*.5 - 0.2# 0.2 sky level from prevous calibration
meanL = meanLcp - 0.2
meanR = meanRcp - 0.2
...
#SNR = meanI[0:1000].mean()/meanV[0:1000].std()
sens =   meanV[0:1000].std()
meanL *= sfuScale
meanR *= sfuScale
...
pl0.xaxis.set_major_formatter(PL.FuncFormatter(hhmm_format));
#pl0.plot(timeInterp, (meanLInterp + meanRInterp)*.5, label = 'I')
#pl0.plot(timeInterp, (meanLInterp - meanRInterp)*.5, label = 'V')
pl0.plot(timeInterp[25000:-100], meanLInterp[25000:-100], label = 'L')
pl0.plot(timeInterp[25000:-100], meanRInterp[25000:-100], label = 'R')
