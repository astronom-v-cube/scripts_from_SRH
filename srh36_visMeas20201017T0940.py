...
pl0.set_title(dateTime + ', 3000 MHz SNR %.3f' % (SNR_211_213))
pl0.set_xlabel('UTC')
pl0.grid()
pl0.legend()

singleNoise_211 = amp_211_noise[3100:3100 + 2000]
singleNoise_213 = amp_213_noise[3100:3100 + 2000]
pairNoise = vis_211_213_noise[3100:3100 + 2000]
freqs = (NP.linspace(0,1999,2000)-1000) * 1/(2000*.1)

PL.figure(figsize=(10,10))
pl0 = PL.subplot(111)
#pl0.plot(freqs,NP.roll(NP.abs(NP.fft.fft(singleNoise_211)),1000))
#pl0.plot(freqs,NP.roll(NP.abs(NP.fft.fft(singleNoise_213)),1000))
