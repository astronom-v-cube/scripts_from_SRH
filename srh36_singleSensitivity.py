...
class SingleAntennaMeasurement():
...
skySunSNR = SingleAntennaMeasurement(1)
#skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20200917/amps/', minMinutes = 508, maxMinutes = 520)
#skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20200918/amps/', minMinutes = 504, maxMinutes = 512)
#skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20200920/amps/', minMinutes = 153, maxMinutes = 157)
#skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20201002/amps/', minMinutes = 423, maxMinutes = 429)
#skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20201002/amps/', minMinutes = 495, maxMinutes = 500)
#skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20201003/amps/', minMinutes = 58, maxMinutes = 68)
skySunSNR.openFits('/var/run/media/svlesovoi/SRH_DATA/SRH36/20201003/amps/', minMinutes = 207, maxMinutes = 214)

PL.figure(figsize=(10,10))
for antenna in range(48):
    antFitsInd = ((antenna // 16) * 32) + (antenna % 16)
#    skySunSNR.show(antenna, antFitsInd, '20200918_4500')
#    skySunSNR.show(antenna, antFitsInd, '20200920_5900')
#    skySunSNR.show(antenna, antFitsInd, '20201002_3000')
#    skySunSNR.show(antenna, antFitsInd, '20201002_4500')
    skySunSNR.show(antenna, antFitsInd, '20201003_5000_1')
