...
sp1.plot(times[0,sunInd0:sunInd1],lcpVis[0,sunInd0:sunInd1,4].real,'.')
sp1.plot(times[0,skyInd0:skyInd1],lcpVis[0,skyInd0:skyInd1,4].real,'.')
sp1.plot(times[0,:],lcpVis[0,:,1].real,'.')
sp1.plot(times[0,:],lcpVis[0,:,1].imag,'.')

amps = lcpVis[0,sunInd0:sunInd1,4].real
fringes = lcpVis[0,sunInd0:sunInd1,1].real
ind = NP.array(NP.linspace(0,amps.shape[0]//2,amps.shape[0]//2+1),dtype='int')
oInd = 2*ind+1
eInd = 2*ind

lcpAmp = amps[oInd[0:-1]]#[80:980]
rcpAmp = amps[eInd[0:-1]]#[80:980]
lcpVis = fringes[oInd[0:-1]]#[80:980]
rcpVis = fringes[eInd[0:-1]]#[80:980]

PL.figure()
PL.plot(detrend(lcpAmp))
PL.plot(detrend(rcpAmp))
PL.plot(detrend(lcpVis))
PL.plot(detrend(rcpVis))

lcpAmpNoise = NP.std(lcpAmp)
rcpAmpNoise = NP.std(rcpAmp)
lcpVisNoise = NP.std(rcpVis)
