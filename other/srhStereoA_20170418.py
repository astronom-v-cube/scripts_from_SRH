...
parser = OptionParser();
parser.add_option("-d", "--date", dest="inDate",   default="20170418");
...
goesFits = fits.open('go1320170418.fits')
...
PL.figure()
PL.title('20170418, 09:36 UT')
PL.ylabel('flux s.f.u.')
PL.xlabel('frequency MHz')
PL.grid()
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-0] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-3] - cpI[:,t1-25])*NP.linspace(5,10,5)*100)
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-1] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-2] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-3] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-4] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-23] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-24] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-25] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
PL.plot(cpFits[1].data['frequencies'],(cpI[:,t1-26] - cpI[:,t1-25])*NP.linspace(5,10,5)*100,'o')
