...
msPath = '/home/sergeyvlesovoi/SRH_0612/20211227_0/'
for ff in range(16):
    print(ff)
...
with open(msPath + 'cleanAllFreqs.py', 'w') as f:
    f.write('freq0 = %d\n'%freq0)
    f.write('curDate = %s\n'%curDate)
    f.write('msPath = \'/home/sergeyvlesovoi/SRH_0612/20211227_0/srh%s_\'\n'%(curDate))
    f.write('imagePath = \'/home/sergeyvlesovoi/SRH_0612/20211227_0/images/cln_\'\n')
...
with open(msPath + 'saveFitses.py', 'w') as f:
    f.write('freq0 = %d\n'%freq0)
    f.write('imagePath = \'/home/sergeyvlesovoi/SRH_0612/20211227_0/images/cln_\'\n')
    f.write('clnFitsPath = \'/home/sergeyvlesovoi/SRH_0612/20211227_0/images/srh_%s_cln_\'\n'%(curDate))
    f.write('for curFreq in range(16):\n')
...
rcpImages = []
for ff in range(16):
    fitName = ('/home/sergeyvlesovoi/SRH_0612/20211227_0/images/srh_%s_cln_%d.fit'%(curDate,int(phaseEdit.srhFits.freqList[ff]*1e-3)))
    clnFits.append(fits.open(fitName))
    lcpImages.append(clnFits[-1][0].data[0,0])
    rcpImages.append(clnFits[-1][0].data[1,0])

lcpImages_20211227_0 = NP.array(lcpImages)
rcpImages_20211227_0 = NP.array(rcpImages)

Y0 = 335
X0 = 363
dXY = 128
srcLcp = lcpImages_20211227_0[:,Y0:Y0+dXY,X0:X0+dXY]
srcRcp = rcpImages_20211227_0[:,Y0:Y0+dXY,X0:X0+dXY]
