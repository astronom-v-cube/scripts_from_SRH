...
amp_213 = fits.open('srh_amp_213_20201003T040018.fits')
vis_211_213 = fits.open('srh_vis_211_213_20201003T040018.fits')

amp_81 = fits.open('srh_amp_81_20201003T040018.fits')
amp_83 = fits.open('srh_amp_83_20201003T040018.fits')
vis_81_83 = fits.open('srh_vis_81_83_20201003T040018.fits')

amp_46 = fits.open('srh_amp_46_20201003T040018.fits')
amp_48 = fits.open('srh_amp_48_20201003T040018.fits')
vis_46_48 = fits.open('srh_vis_46_48_20201003T040018.fits')

amp_101 = fits.open('srh_amp_101_20201003T040018.fits')
amp_104 = fits.open('srh_amp_104_20201003T040018.fits')
vis_101_104 = fits.open('srh_vis_101_104_20201003T040018.fits')
...
pl0.set_ylim((-.5,1.))
pl0.set_title('20201003, 5000 MHz')
pl0.set_xlabel('UTC')
pl0.set_ylabel('correlation')
pl0.grid()
pl0.legend()
PL.savefig('20201003_5000_211_213.png')
...
pl1.set_ylim((-.5,1.))
pl1.set_title('20201003, 5000 MHz')
pl1.set_xlabel('UTC')
pl1.set_ylabel('correlation')
pl1.grid()
pl1.legend()
PL.savefig('20201003_5000_81_83.png')
...
pl1.grid()
pl1.legend()
PL.savefig('20201003_5000_46_48.png')
...
pl1.grid()
pl1.legend()
PL.savefig('20201003_5000_101_104.png')
