...
parser = OptionParser()
parser.add_option("-f", "--file", dest="fitPath", default = '/home/sergey_lesovoi/SRH_DATA/SRH/SRH0612/' + currentDate + '/')
...
cleanPath = '/home/sergey_lesovoi/SRH_DATA/SRH/SRH0612/cleanMaps/'
