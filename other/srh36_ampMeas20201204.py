...
#dateTime = '20201204T041513'
dateTime = '20201204T065711'
...
#        pl0.plot(time[j], amps_lcp[j,i], color='red')
#        pl0.plot(time[j], amps_rcp[j,i], color='blue')
        pl0.plot(time[j], amps_lcp[j,i] + amps_rcp[j,i], color='red')
        pl0.plot(time[j], amps_lcp[j,i] - amps_rcp[j,i], color='blue')
