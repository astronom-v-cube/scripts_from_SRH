...
msPath = '/home/sergey_lesovoi/SRH_06_12_data/20211230_0/'
for ff in range(16):
    print(ff)
...
imagePath = '/home/sergey_lesovoi/SRH_06_12_data/20211230_0/images/cln_'
...
clnFitsPath = '/home/sergey_lesovoi/SRH_06_12_data/20211230_0/images/srh_%s_cln_'%(curDate)
for curFreq in range(16):
...
rcpImages = []
for ff in range(16):
    fitName = ('/home/sergey_lesovoi/SRH_06_12_data/20211230_0/images/srh_%s_cln_%d.fit'%(curDate,int(phaseEdit.srhFits.freqList[ff]*1e-3)))
