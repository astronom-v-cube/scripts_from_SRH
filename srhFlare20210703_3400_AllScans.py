...
for fitsName in iFitses:
    ...
    mm = int(tHMS[1])
    ss = int(tHMS[2])
    time_0703_3400.append(hh*3600 + mm*60 + ss + int(tObs[1])*1e-6)
    fitsHandle.close()
...
flux_0703_3400 = []#iImages3400[:,365:400,325:350].mean(axis=(1,2))
Tbmax_0703_3400 = []
for i in range(frames):
#    Tbmax3400.append(iImages3400[i,365:400,325:350].max())
    Tbmax_0703_3400.append(iImages3400[i,383,337])
    flux_0703_3400.append(2*iImages3400[i,365:400,325:350].sum()*scipy.constants.k/(scipy.constants.c/3.4e9)**2 * NP.deg2rad(4.911/3600)**2 / 1e-22)
