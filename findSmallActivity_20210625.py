...
srcYX  = NP.array([[220, 39],  [243, 137], [256, 212], [222, 94],  [396, 136], [277, 208]])
qSunYX = NP.array([[150, 324], [125, 102], [180, 340], [360, 190], [300, 110], [244, 185]])
skyYX  = NP.array([[374, 52],  [387, 34],  [395, 120], [400, 97],  [300, 205],   [183, 53]])
...
pl.legend()
pl.grid()
pl.set_xlim(4*3600 + 32*60,4*3600 + 35*60)
pl.set_ylim(0,1.5)
...
pl = fig.subplots(nrows=1,ncols=1)
pl.xaxis.set_major_formatter(PL.FuncFormatter(hms_format))
pl.xaxis.set_major_locator(PL.MultipleLocator(15))
...
pl.legend()
pl.grid()
pl.set_xlim(4*3600 + 33*60,4*3600 + 35*60)
pl.set_ylim(-0.01,.39)
