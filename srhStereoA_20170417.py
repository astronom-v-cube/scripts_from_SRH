...
parser = OptionParser();
parser.add_option("-d", "--date", dest="inDate",   default="20170417");
...
goesFits = fits.open('go1320170417.fits')
...
pl0.plot(goesTime[0,:],goesFlux[0,:,0]*1e4,color='red')
pl0.plot(goesTime[0,:],goesFlux[0,:,1]*1e4,color='blue')
pl0.legend()
