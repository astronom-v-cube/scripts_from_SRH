...
#        self.setGeometry(100,100,1024,700)
        ...
        self.sPhaseStairLcp = QtWidgets.QDoubleSpinBox(self, prefix='S stair L ')
        ...
        self.sPhaseStairRcp = QtWidgets.QDoubleSpinBox(self, prefix='S stair R ')
...
#        
        ...
        self.nonlinearButton.setChecked(True)
...
#        self.casaWidget.layout.addWidget(self.casaRightCanvas,5,1)
        ...
        self.tab2.layout.addWidget(self.nonlinearButton, 0, 2)
        self.tab2.layout.addWidget(self.calculatePhaseButton, 0, 3)
        self.tab2.layout.addWidget(self.calculatePhaseCurrentButton, 1, 3)
        self.tab2.layout.addWidget(self.loadGainsButton, 0, 4)
        self.tab2.layout.addWidget(self.saveGainsButton, 1, 4)
...
phaseEdit_0612 = SrhEdik();
phaseEdit_0612.setWindowTitle('SRH editor')
phaseEdit_0612.show();
